  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const body = {
        ...
        dmSystemInstruction: postMode === 'AI' ? dmSystemInstruction : '',
          ...
          <div className="glass-card" style={{ marginBottom: '20px' }}>
            <div className="section">
              ...
              <div className="form-group">
                ...
                <input id="karotter-password" type="password" className="input-field"
          ...
          <div className="glass-card" style={{ marginBottom: '20px' }}>
            <div className="section">
              ...
              {autoPostMode === 'FIXED_INTERVAL' && (
                <div style={{ borderTop: '1px solid var(--color-border)', paddingTop: '20px' }}>
                  <div className="form-group">
                    <label className="label" htmlFor="fixed-interval">投稿間隔（分）※小数可</label>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                      <input id="fixed-interval" type="number" className="input-field" style={{ maxWidth: '120px' }} step="0.1"
